...
- Behavior: `SyncRuntimeClient.capture_snapshot(..., require_immediate_admission=True)` adds the typed runtime admission envelope while preserving queued admission by default.
